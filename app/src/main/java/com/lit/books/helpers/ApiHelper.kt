...
class ApiHelper(var context: Context) {
    ...
    fun post(api: String, jsonData: JSONObject, callBack: CallBack) {
        ...
        // Set the connect timeout to 30 seconds (in milliseconds)
        client.setConnectTimeout(45 * 1000)

// Set the response timeout to 30 seconds (in milliseconds)
        client.setResponseTimeout(45 * 1000)
        ...
        client.post(context, api, con_body, "application/json",
            object : JsonHttpResponseHandler() {
                ...
                override fun onFailure(
                    ...
                    //Toast.makeText(context, ""+statusCode+":"+throwable.toString(), Toast.LENGTH_SHORT).show()
                }
            })
    }//END POST
